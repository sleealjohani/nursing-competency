...
/**
 * Builds the hospital's competency form in the DOM: the same letterhead and
 * logos, field grid, bordered assessment table and pair of footer boxes as the
 * source PDF, with the nurse's answers ticked into the M / NM / NA boxes.
 *
 * Shared by the print page and the ZIP export, so both produce exactly the
 * same paper and neither can drift from the other.
 *
